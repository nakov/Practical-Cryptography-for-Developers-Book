...
The RSA **private key** will be given encoded in [**PEM format**](https://en.wikipedia.org/wiki/Privacy-Enhanced\_Mail) ([RFC 7468](https://tools.ietf.org/html/rfc7468), see the example). The corresponding RSA **public key** will also be given encoded in **PEM format**. The RSA **signature** is 4096-bit integer (1024 hex digits).
