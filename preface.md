...
Currently Svetlin Nakov together with his partners drive the global expansion of the largest training center for software engineers in Bulgaria – the **Software University** \([https://softuni.org\](https://softuni.org\)\), where he inspires and teaches hundred of thousands of young people in computer science, software development, information technologies and digital skills, gives them a profession and a job.
